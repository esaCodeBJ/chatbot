...
const phraseDictionary = {
    ...
    "comment tu t'appelles": "Je m'appelle Mohamed. Et toi, comment tu t'appelles ?",
    "ton prénom": "Je m'appelle Mohamed. C'est un joli prénom, non ?",
    ...
    "ton nom": "Je suis Mohamed. ",
    "quel est ton nom": "Je suis Mohamed. ",
    "donne-moi ton nom": "Je suis Mohamed. ",
    "donne moi ton nom": "Je suis Mohamed. ",
    "comment tu t'appelles": "Je m'appelle Mohamed.",
...
const generateResponse = (chatElement, userMessage) => {
    ...
    fetch(API_URL, requestOptions).then(res => res.json()).then(data => {
        ...
        chatElement.querySelector("p").textContent = "Erreur lors de la récupération de la réponse.";
